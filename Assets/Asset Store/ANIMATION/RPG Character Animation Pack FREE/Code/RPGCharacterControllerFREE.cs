...
namespace RPGCharacterAnims{
	...
	public class RPGCharacterControllerFREE : MonoBehaviour{
				...
				if(canAction){
					if(!isBlocking){
						...
						if(rpgCharacterInputController.inputAttackL
							&& rpgCharacterInputController.inputHorizontal == 0
							&& rpgCharacterInputController.inputVertical == 0) {
							Attack(1);
						}
		...
		public void Attack(int attackSide){
			StartCoroutine(Player._instance.Attack(attackAnimationTime));	// enable damage detection
