...
public class AI_Enemy : MonoBehaviour {
    ...
    private LineofSight ThisLineSight = null;
    ...
    //------------------------------------------
    void Awake() {
        ThisLineSight = GetComponent<LineofSight>();
    ...
    public IEnumerator AIPatrol() {
        ...
        while(currentstate == ENEMY_STATE.PATROL) {
            //Set strict search
            ThisLineSight.Sensitivity = LineofSight.SightSensitivity.STRICT;
    ...
    public IEnumerator AIChase() {
        ...
        while(currentstate == ENEMY_STATE.CHASE) {
            //Set loose search
            ThisLineSight.Sensitivity = LineofSight.SightSensitivity.LOOSE;
            ...
            if(ThisAgent.remainingDistance <= ThisAgent.stoppingDistance) {
                ...
                if(!ThisLineSight.CanSeeTarget)
                    CurrentState = ENEMY_STATE.PATROL;
                else //Reached destination and can see player. Reachedattacking distance
